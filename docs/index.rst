...
The ASDF FITS Schemas define a set of schemas for serializing the FITS format, see
:ref:`astropy.io.fits <astropy:astropy-io-fits>` for the ASDF file format. These schemas
...
.. note::
   This is only a schema package, to use these schemas to serialize FITS,
